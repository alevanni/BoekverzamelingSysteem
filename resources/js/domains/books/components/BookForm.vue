    ...
    <form class="app-form" @submit.prevent="submitForm">
        <table>
            ...
            <tr>
                ...
                <td><input v-model=bookCopy.title id="title" type="text"></td>
            </tr>
            <tr>
                <td><label for="plot">Plot</label></td>
                <td><input v-model=bookCopy.plot id="plot" type="textarea" style="height:200px; width:400px"></td>
            </tr>
            <tr>
                <td><label for="submit">Submit</label></td>
                <td><input id="submit" type="submit" :value="book.title == '' ? 'Add book' : 'Edit Book'"></td>
            </tr>
        </table>
